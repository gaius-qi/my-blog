    ...
    methods: {
      change () {
        ...
        if(temp !== null && temp !== undefined && temp !== '' && /^[0-9]*$/.test(temp) && temp !== this.location_message && /^\d{6,8}$/.test(temp)){
          ...
          this.n1 = 'N:' + (32 + Math.random() * 5).toFixed(2)
          this.s1 = 'S:' + (-95 - Math.random() * 5).toFixed(2)
          this.n2 = 'N:' + (32 + Math.random() * 5).toFixed(2)
          this.s2 = 'S:' + (-95 - Math.random() * 5).toFixed(2)
          this.n3 = 'N:' + (32 + Math.random() * 5).toFixed(2)
          this.s3 = 'S:' + (-95 - Math.random() * 5).toFixed(2)
          this.n4 = 'N:' + (32 + Math.random() * 5).toFixed(2)
          this.s4 = 'S:' + (-95 - Math.random() * 5).toFixed(2)
          this.n5 = 'N:' + (32 + Math.random() * 5).toFixed(2)
          this.s5 = 'S:' + (-95 - Math.random() * 5).toFixed(2)
          this.n6 = 'N:' + (32 + Math.random() * 5).toFixed(2)
          this.s6 = 'S:' + (-95 - Math.random() * 5).toFixed(2)
          this.n7 = 'N:' + (32 + Math.random() * 5).toFixed(2)
          this.s7 = 'S:' + (-95 - Math.random() * 5).toFixed(2)
          this.n8 = 'N:' + (32 + Math.random() * 5).toFixed(2)
          this.s8 = 'S:' + (-95 - Math.random() * 5).toFixed(2)
        }
